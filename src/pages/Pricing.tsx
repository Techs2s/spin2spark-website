      ...
      <section id="pricing-table" className="py-12 px-4 sm:py-16 bg-gray-900">
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Our Pricing</h2>
            <p className="text-lg sm:text-xl text-gray-300">Pay only for what you need</p>
          </div>
      ...
      <section className="py-12 px-4 sm:py-16 bg-gray-900">
        <div className="container mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-lg text-white">What services are included?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-300">All our services include pickup and delivery within our service area. Pricing varies based on the type of service and items being cleaned.</p>
              </CardContent>
            </Card>
          </div>
        </div>
